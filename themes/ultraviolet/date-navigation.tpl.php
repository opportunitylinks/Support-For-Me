 ...
 *
 * webmech updates :- spans added as per http://drupal.org/node/339279#105 part of date_fix
 *                    mods to show other calendar months without reloading tabs page in panels
 */
?>
<div class="date-nav clear-block">
  ...
  <div class="date-next">&nbsp;
    <?php if (!empty($next_url)) : ?>
      ...
      <span class="attachment">
      <span class="views-summary">
    <?php print l(($block ? '' : date_t('Next', 'date_nav')) . ' »', $next_url, $next_options); ?>
      </span>
      </span>
      </span>
    <?php endif; ?>  
